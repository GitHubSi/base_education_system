...
public class JwtUtil {
    // 过期时间 12 小时
    private static final long EXPIRE_TIME = 60 * 12 * 60 * 1000;
    // 密钥
    private static final String SECRET = "SI+SHIRO+JWT";
     ...
     * @return 是否正确
     */
    public static boolean verify(String token, String userNumber) {
        try {
            Algorithm algorithm = Algorithm.HMAC256(SECRET);
